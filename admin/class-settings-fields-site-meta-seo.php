...
class Settings_Fields_Site_Meta_SEO {
	...
	private function dependencies() {
		...
		require TIMS_PATH . 'admin/partials/field-callbacks/class-meta-seo-callbacks.php';
	...
	public function settings() {
		...
		add_settings_field(
			...
			'tims-site-meta-seo',
			'tims-site-meta-seo',
			[ esc_html__( 'Disable if your theme includes SEO meta tags or if you plan on using an SEO plugin.', 'tims' ) ]
		);
		...
		add_settings_field(
			'schema_org_type',
			__( 'Organization Type', 'tims' ),
			[ Partials\Field_Callbacks\Meta_SEO_Callbacks::instance(), 'schema_org_type' ],
			'tims-site-meta-seo',
			'tims-site-meta-seo',
			[ esc_html__( 'Select a category that generally applies to this website.', 'tims' ) ]
		);
 ...
 */
function tims_settings_fields_site_meta_seo() {
...
tims_settings_fields_site_meta_seo();