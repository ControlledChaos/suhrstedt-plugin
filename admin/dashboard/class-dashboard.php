...
class Dashboard {
	...
	private function dependencies() {
        ...
        // require TIMS_PATH . 'admin/dashboard/class-dashboard-widget.php';

        // Get the welcome panel class.
        require TIMS_PATH . 'admin/dashboard/class-welcome.php';
    ...
    public function metaboxes() {
        ...
        || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            ...
            $hide = get_field( 'tims_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            // Get options.
            $welcome    = get_option( 'tims_hide_welcome' );
            $gutenberg  = get_option( 'tims_hide_try_gutenberg' );
            $wp_news    = get_option( 'tims_hide_wp_news' );
            $quickpress = get_option( 'tims_hide_quickpress' );
            $at_glance  = get_option( 'tims_hide_at_glance' );
            $activity   = get_option( 'tims_hide_activity' );
    ...
    public function add_help() {
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Dashboard Widgets', 'tims' ),
			'content'  => null,
	...
	public function help_welcome_panel() {
        ...
        include_once TIMS_PATH . 'partials/help/help-welcome-panel.php';
	...
	public function help_dashboard_widgets() {
        ...
        include_once TIMS_PATH . 'partials/help/help-dashboard-widgets.php';
	...
	public function styles() {
        ...
        if ( $screen->id == 'dashboard' ) {
            wp_enqueue_style( TIMS_ADMIN_SLUG . '-dashboard', TIMS_URL .  'admin/dashboard/assets/css/dashboard.css', [], null, 'screen' );
        }
