...
class Settings_Page_Scripts {
    ...
    public function settings_page() {
		...
		$this->page_help_section = add_options_page(
			__( 'Script Options', 'tims' ),
			__( 'Script Options', 'tims' ),
			'manage_options',
			TIMS_ADMIN_SLUG . '-scripts',
			[ $this, 'page_output' ]
		);
    ...
    public function page_output() {
		...
		require TIMS_PATH . 'admin/partials/settings-page-scripts.php';
	...
	public function help_inline_scripts() {
		...
		include_once TIMS_PATH . 'admin/partials/help/help-inline-scripts.php';
	...
	public function help_inline_jquery() {
		...
		include_once TIMS_PATH . 'admin/partials/help/help-inline-jquery.php';
	...
	public function help_remove_emoji() {
		...
		include_once TIMS_PATH . 'admin/partials/help/help-remove-emoji.php';
    ...
    public function page_help_section_sidebar() {
		...
		$html = '<ul>
			<li><a href="https://github.com/kenwheeler/slick" target="_blank" style="text-decoration: none;">' . __( 'Slick on GitHub', 'tims' ) . '</a></li>
			<li><a href="https://github.com/vdw/Tabslet" target="_blank" style="text-decoration: none;">' . __( 'Tabslet on GitHub', 'tims' ) . '</a></li>
			<li><a href="https://github.com/leafo/sticky-kit" target="_blank" style="text-decoration: none;">' . __( 'Sticky-kit on GitHub', 'tims' ) . '</a></li>
			<li><a href="https://github.com/iamceege/tooltipster" target="_blank" style="text-decoration: none;">' . __( 'Tooltipster on GitHub', 'tims' ) . '</a></li>
		</ul>';
 ...
 */
function tims_settings_page_scripts() {
