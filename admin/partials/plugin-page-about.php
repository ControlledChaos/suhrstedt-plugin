...
$settings_icon = sanitize_text_field( get_option( 'tims_site_settings_link_icon' ) );
...
$page_tabs = apply_filters( 'tims_tabs_page_about', $tabs );
...
<div class="wrap site-plugin-wrap">
	...
	<div class="backend-tabbed-content">
		...
		do_action( 'tims_content_page_about_before' ); ?>
		<!-- Begin content -->
