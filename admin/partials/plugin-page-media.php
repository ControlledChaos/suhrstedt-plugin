...
<p><?php _e( 'When you upload an image, whether directly to the media library or through the Features/TV and Commercials interface, WordPress will automatically crop them to default dimensions. Your website also has custom image sizes for the 16:9 HD video aspect ratio, for the screenshot images used as placeholders for the videos.', 'tims' ); ?></p>
