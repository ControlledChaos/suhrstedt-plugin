...
final class Post_Types_Register {
    ...
    public function register() {
		...
		$labels = [
			'name'                  => __( 'Features', 'tims' ),
			'singular_name'         => __( 'Feature Project', 'tims' ),
			'menu_name'             => __( 'Features', 'tims' ),
			'all_items'             => __( 'All Features', 'tims' ),
			...
			'view_items'            => __( 'View Features', 'tims' ),
			'search_items'          => __( 'Search Features', 'tims' ),
			'not_found'             => __( 'No Features Found', 'tims' ),
			'not_found_in_trash'    => __( 'No Features Found in Trash', 'tims' ),
			...
			'filter_items_list'     => __( 'Filter Features', 'tims' ),
			'items_list_navigation' => __( 'Features list navigation', 'tims' ),
			'items_list'            => __( 'Features list', 'tims' ),
			'attributes'            => __( 'Feature Attributes', 'tims' ),
			'parent_item_colon'     => __( 'Parent Project', 'tims' ),
		];

		$args = [
			'label'               => __( 'Features', 'tims' ),
			'labels'              => $labels,
			'description'         => __( '', 'tims' ),
			'public'              => true,
