			...
			acf_add_local_field_group( [
				...
				'fields' => [
					...
					[
						...
						'type'              => 'image',
						'instructions'      => __( 'If no image is uploaded then the screenshot from Vimeo will be used. This can be used to replace an inferior image provided by Vimeo. Minimum 960 X 540 pixels.', 'tims' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
